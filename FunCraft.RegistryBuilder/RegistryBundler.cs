...
internal class RegistryBundler(string generatedFolder)
{
    ...
    private static readonly Dictionary<string, string> s_nbtRegistries = new()
    {
    ...
    public void Write(string outputPath)
    {
        ...
        foreach (var (suffix, relPath) in s_nbtRegistries)
        {
        ...
        foreach (var (regId, entries) in registries)
        {
            ...
            var hasNbtDir = s_nbtRegistries.TryGetValue(suffix, out var relPath);
